...
import { properties } from './ApifyGoogleHotels.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'ahpk7S3a62kOzKdE9' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-hotels-api' as string;
export const CLASS_NAME = 'ApifyGoogleHotels' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-hotels-app' as string;

export const DISPLAY_NAME = 'Google Hotels' as string;
export const DESCRIPTION =
	'Search hotels and vacation rentals and return names, nightly rates, ratings, and amenities' as string;

export class ApifyGoogleHotels implements INodeType {
